...
export const purchaseProducts = createAction('[Products] Purchasing products');
export const purchasedProducts = createAction('[Products] Purchased products', props<{ loading: boolean }>());
